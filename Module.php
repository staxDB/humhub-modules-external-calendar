...
class Module extends ContentContainerModule
{
    ...
    public function enable()
    {
        ...
        if (!Yii::$app->hasModule('calendar') && !isset(Yii::$app->modules['calendar'])) {
            Yii::$app->getView()->warn(Yii::t('ExternalCalendarModule.base', 'Module {enablingModule} cannot be enabled without enabled module {requiredModule}!', [
                'enablingModule' => '\'' . $this->getName() . '\'',
